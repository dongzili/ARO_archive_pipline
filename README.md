...
NOTE:
* It will automatically group per 1000 files into a tarball for optimal archiving speed. 
* It will automatically check if the number of files synced matches the one in groundhog, if not, will sync again
